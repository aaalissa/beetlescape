...
"""
based on Revisiting k-means: New Algorithms via Bayesian Nonparametrics (Kulis and Jordan, 2011)
from: https://github.com/vsmolyakov/DP_means/blob/master/python/dpmeans.py
"""
